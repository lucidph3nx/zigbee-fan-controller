...
#define CONFIG_FAN_PIN 1

const uint8_t au8ManufacturerName[] = {10,'L','I','L','Y','G','O', '.', 'F', 'a', 'n'};
...
void setup()
{
    ...
    pinMode(CONFIG_FAN_PIN, OUTPUT);
    digitalWrite(CONFIG_BLUE_LIGHT_PIN, LOW);
    digitalWrite(CONFIG_FAN_PIN, LOW);
...
void handleClick(void)
{
    ...
    digitalWrite(CONFIG_FAN_PIN, ledState);
}
            ...
            switch (sHciMsg.u16MsgType)
            {
                ...
                case ZBHCI_CMD_ZCL_ONOFF_CMD_RCV:
                    ...
                    else if (sHciMsg.uPayload.sZclOnOffCmdRcvPayload.u8CmdId == 1)
                    {
                        ...
                        digitalWrite(CONFIG_FAN_PIN, HIGH);
                        ledState = 1;
                    }
